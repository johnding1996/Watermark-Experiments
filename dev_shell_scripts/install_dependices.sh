...
pip install transformers diffusers==0.23.1 'datasets[vision]' ftfy
# Other machine learning libraries
pip install onnx onnxruntime-gpu open_clip_torch scikit-learn scikit-image pandas torchmetrics torchattacks
